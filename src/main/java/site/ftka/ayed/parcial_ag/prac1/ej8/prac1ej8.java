package site.ftka.ayed.parcial_ag.prac1.ej8;

import java.util.LinkedList;
import java.util.Queue;

public class prac1ej8 {

    /*
        8. El objetivo de este punto es ejercitar el uso de la API de listas de Java
            y aplicar conceptos de la programación orientada a objetos.
            Sean las siguientes especificaciones de cola, cola circular y cola con 2 extremos disponibles,
            vistas en la explicación teórica:
     */
    ...
    public static void main(String[] args) {
        ...
        Queue<String> listaEstudiantes = new LinkedList<>();
