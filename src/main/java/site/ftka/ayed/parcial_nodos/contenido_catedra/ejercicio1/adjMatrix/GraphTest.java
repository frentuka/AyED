package site.ftka.ayed.parcial_nodos.contenido_catedra.ejercicio1.adjMatrix;
...
import site.ftka.ayed.parcial_nodos.contenido_catedra.ejercicio1.Edge;
import site.ftka.ayed.parcial_nodos.contenido_catedra.ejercicio1.Graph;
import site.ftka.ayed.parcial_nodos.contenido_catedra.ejercicio1.Vertex;
...
public class GraphTest {
	...
	public void testGetSetData() {
		assertEquals(1, Optional.ofNullable(vert1.getData()));
		vert1.setData(5);
		assertEquals(5, Optional.ofNullable(vert1.getData()));
	}
